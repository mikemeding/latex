...
\newcommand{\lstsetxml}{
 ...
 \lstdefinelanguage{XML}
 {
   ...
   morestring=[s]{"}{"},
   morecomment=[s]{<!--}{-->},
   morekeywords={xmlns,version,type,name,value,connector-ref,security-realm,worker,username,protocol,outbound-socket-binding-ref}% list your attributes here       
 } 
